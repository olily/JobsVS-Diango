    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=255, unique=True, verbose_name='城市')),
                ('city_zh', models.CharField(blank=True, db_index=True, max_length=255, null=True, verbose_name='城市名')),
